      ...
      <div className="w-full flex justify-center items-center h-full ">
        ...
        >
          ...
          <div className="flex flex-col gap-1 justify-center h-full">
            ...
            {/* Grid Div 2 */}
            <div className="grid grid-cols-11 gap-3 h-full -mt-[3%]">
              ...
              <div className="flex flex-col col-span-4 gap-5 items-center rounded-2xl color bg-terracota p-5 h-[90%]">
                {/* Div Desenho */}
                <div className="flex gap-[16.2px] bg-default w-full h-[50%] items-end rounded-2xl">
                ...
                <div className="flex gap-3 items-center text-3xl text-white font-semibold">
                  <img src={piggyBank} alt="Piggy Icon" />
                  <h2>
              ...
              <div className="flex col-span-4 h-[90%] bg-yellow-cream rounded-2xl">
                ...
                <div className="h-full flex items-center justify-center px-12">
                  <h2 className="text-orange text-[2.5rem] font-bold">
              ...
              <div className="flex flex-col items-center justify-center col-span-3 h-[90%] bg-brown-dark">
                ...
                <div className="w-[90%] bg-terracota"></div>
              </div>
            </div>
          </div>
        </LargeCard>
