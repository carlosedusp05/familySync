...
function ItemEvents(props) {
  return (
    <div
      className="w-[87%] flex justify-beetwen flex-col gap-2 rounded-2xl bg-white-yellow relative pl-5 pr-8
     pt-2 pb-10 transition-all duration-400 hover:scale-103"
    >
